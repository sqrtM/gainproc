...
bool test_cmpa() {
    ...
    cmpa(&mix, 0, 5);
    if (mix.comp != L) {
        print_ko(__func__, "Test 1 failed, basic compare issue L");
        return false;
    }
    ...
    cmpa(&mix, 1, 5);
    if (mix.comp != G) {
        print_ko(__func__, "Test 2 failed, basic compare issue G");
        return false;
    }
    ...
    cmpa(&mix, 2, 5);
    if (mix.comp != E) {
        print_ko(__func__, "Test 3 failed, basic compare issue E");
        return false;
    }
    ...
    cmpa(&mix, 3, 28);
    if (mix.comp != G) {
        print_ko(__func__, "Test 4 failed, field issue");
        return false;
    }
    print_info("4 - field");
