...
bool test_lda() {
    ...
    if (mix.A->value != 0b111111000000111111000000) {
        print_ko(__func__, "Test 1 failed, basic load issue");
        return false;
    }
    ...
    if (mix.A->value != 0b111111000000) {
        print_ko(__func__, "Test 2 failed, shifted load problem");
        return false;
    }
    ...
    if (mix.A->value != 0b111111000000111111000000 || mix.A->sign != false) {
        print_ko(__func__, "Test 3 failed, sign assignment incorrect");
        return false;
    }
    ...
    if (mix.A->value != 0b101011) {
        print_ko(__func__, "Test 4 failed, single segment issue");
        return false;
    }
    ...
    if (mix.A->value != 0 || mix.A->sign != false) {
        print_ko(__func__, "Test 5 failed, take sign only issue");
        return false;
    }
    ...
    lda(&mix, 5, 5, true);
    if (mix.A->value != 0b111111000000111111000000 || mix.A->sign != false) {
        print_ko(__func__, "Test 6 failed, switch sign issue");
        return false;
    }
...
bool test_ldi() {
    ...
    if (err != 1) {
        print_ko(__func__, "Test 7 failed, illegal i register");
        return false;
    }
